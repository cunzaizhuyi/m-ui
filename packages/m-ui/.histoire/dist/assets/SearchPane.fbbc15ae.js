import { _ as __vitePreload } from "./mapping.7d29949b.js";
import { Y as markRaw, d as defineComponent, r as ref, a2 as useFocus, w as watch, a3 as refDebounced, c as computed, a as openBlock, b as createElementBlock, e as createBaseVNode, l as createVNode, i as unref, I as Icon, L as withDirectives, a4 as vModelText, v as withKeys, g as withModifiers, j as createBlock, k as withCtx, F as Fragment, H as renderList, m as createCommentVNode, Q as createTextVNode, a5 as flexsearch, P as useCssVars, a6 as toRefs, a7 as useRouter, n as normalizeClass, t as toDisplayString } from "./vendor.0f2c2782.js";
import { u as useStoryStore, _ as _export_sfc, a as useScrollOnActive, o as onKeyboardShortcut, B as BaseListItemLink } from "./bundle-main.f572992b.js";
import { B as BaseEmpty } from "./BaseEmpty.b233c15c.js";
let searchData$1 = { "index": { "reg": '{"0":1,"1":1,"2":1,"3":1}', "text.cfg": '{"doc":0,"opt":1}', "text.map": '[{"p":[0,1,2,3],"po":[0,1,2,3],"pot":[0,1,2,3],"poto":[0,1,2,3],"potom":[0,1,2,3]},{"t":[1,2,3],"te":[1,2,3],"tem":[1,2,3],"temo":[1,2,3],"temo1":[1],"temo2":[2],"temo3":[3]},{},{},{},{},{},{},{}]', "text.ctx": "[{}]" }, "idMap": { "0": { "id": "demo-demo-story-vue", "kind": "story" }, "1": { "id": "demo-demo-story-vue:demo-demo-story-vue-0", "kind": "variant" }, "2": { "id": "demo-demo-story-vue:demo-demo-story-vue-1", "kind": "variant" }, "3": { "id": "demo-demo-story-vue:demo-demo-story-vue-2", "kind": "variant" } } };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data.ba151439.js"), true ? ["assets/search-docs-data.ba151439.js","assets/vendor.0f2c2782.js"] : void 0);
    function close() {
      emit("close");
    }
    const input = ref();
