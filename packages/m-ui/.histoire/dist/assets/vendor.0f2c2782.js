...
function rectToClientRect$1(rect) {
  return __spreadProps3(__spreadValues3({}, rect), {
    top: rect.y,
    left: rect.x,
...
const computePosition$2 = (reference, floating, options) => computePosition$3(reference, floating, __spreadValues3({
  platform: platform$1
}, options));
...
function fullIcon$1(data) {
  return __spreadValues3(__spreadValues3({}, iconDefaults$1), data);
}
...
function getIconData$1$1(data, name, full) {
...
function listToIcons$1(list, validate, simpleNames2 = false) {
  const result = [];
  list.forEach((item) => {
  ...
  !function(t2, n2) {
    ...
    return t2 = { 770: function(t3, n3, e2) {
      ...
      var n3 = (typeof document != "undefined" && document.currentScript && document.currentScript.src, function(t4) {
        ...
        o = null, r2.arguments && (f = r2.arguments), r2.thisProgram && r2.thisProgram, r2.quit && r2.quit;
        var g, _;
        ...
        function O2(t5, n5, e3) {
          ...
          for (var o2 = ""; n5 < i2; ) {
            ...
            if (128 & a3) {
              ...
              if ((224 & a3) != 192) {
                var s = 63 & t5[n5++];
                if ((a3 = (240 & a3) == 224 ? (15 & a3) << 12 | f2 << 6 | s : (7 & a3) << 18 | f2 << 12 | s << 6 | 63 & t5[n5++]) < 65536)
        ...
        function ot(t5, n5, e3, r3) {
          for (var i2 = 0, o2 = 0; o2 < e3; o2++) {
            for (var a3 = A[n5 + 8 * o2 >> 2], f2 = A[n5 + (8 * o2 + 4) >> 2], s = 0; s < f2; s++)
        ...
        function ct(t5) {
          ...
          t5 = t5 || f, B > 0 || (I2(), B > 0 || (r2.setStatus ? (r2.setStatus("Running..."), setTimeout(function() {
            setTimeout(function() {
              r2.setStatus("");
            }, 1), e3();
          }, 1)) : e3()));
